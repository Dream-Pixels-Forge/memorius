...
| "search the web" / "look this up" / no local match | `web` (+ `--web` on search/context/factcheck) | `memorius web "python 3.13 changelog"` (provider: `duckduckgo` keyless | `tavily` keyed via TAVILY_API_KEY) |
